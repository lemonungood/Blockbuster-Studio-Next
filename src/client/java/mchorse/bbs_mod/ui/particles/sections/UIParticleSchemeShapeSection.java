...
public class UIParticleSchemeShapeSection extends UIParticleSchemeModeSection<ParticleComponentShapeBase>
{
    ...
    {
        if (this.component instanceof ParticleComponentShapeAABB)
        {
            ParticleComponentShapeAABB box = (ParticleComponentShapeAABB) this.component;
    ...
    protected Class getModeClass(int value)
    {
        if (value == 1)
        {
            return ParticleComponentShapeAABB.class;
        }
        else if (value == 2)
        {
    ...
    protected void fillData()
    {
        ...
        if (this.component instanceof ParticleComponentShapeAABB || this.component instanceof ParticleComponentShapeDisc)
        {
            this.label.label = this.component instanceof ParticleComponentShapeAABB ? UIKeys.SNOWSTORM_SHAPE_BOX_SIZE : UIKeys.SNOWSTORM_SHAPE_NORMAL;
