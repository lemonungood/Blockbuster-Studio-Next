...
public class UIDraggable extends UIElement
{
    ...
    private int mouseX;
    private int mouseY;
    private Vector2i referenceMouseHandler;
    ...
    protected boolean subMouseClicked(UIContext context)
    {
        if (this.area.isInside(context) && context.mouseButton == 0)
        {
            ...
            {
                this.referenceMouseHandler = this.reference.get();
            }
    ...
    public void render(UIContext context)
    {
        ...
        if (this.dragging && this.callback != null)
        {
            ...
            if (this.referenceMouseHandler != null)
            {
                context.mouseX = this.referenceMouseHandler.x + (mouseX - this.mouseX);
                context.mouseY = this.referenceMouseHandler.y + (mouseY - this.mouseY);
            }
